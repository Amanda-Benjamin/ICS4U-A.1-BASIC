    ...
    */
    ...
    public static void main(final String[] args) {
        ...
        while (retry) {
            ...
            System.out.println("YOU ENTER THE NUMBER OF TIMES YOU WANT "
                                + "THE COMPUTER");
            System.out.println("TO "
                                + "'ROLL' THE DICE. WATCH OUT, VERY "
                                + "LARGE NUMBERS TAKE");
            System.out.println("A LONG TIME, IN PARTICULAR"
                                + ", NUMBERS OVER 5000\n");
            ...
            for (int amountcounter = 0; amountcounter <= 12; amountcounter++) {
                System.out.println("TOTAL SPOTS "
                + amountcounter
                + "        NUMBER OF TIMES "
                + frequency[amountcounter]);
            }
